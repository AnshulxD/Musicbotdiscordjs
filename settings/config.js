module.exports = {
  TOKEN:
    process.env.TOKEN ||
    "OTQwODk4ODEzNzg1MzAxMDUy.YgOGTg.IoqEFoZnUqs7g8z1bFxP_Rnqx5A",
  PREFIX: process.env.PREFIX || "$",
  embed: {
    color: process.env.color || "#220f80",
    wrongcolor: process.env.wrongcolor || "#8a0808",
    footertext: "Coded By Sed#0324",
    footericon: "",
  },
  emoji: {
    ERROR: "❌",
  ...
  mongodb : process.env.mongodb || "mongodb+srv://NotJustPublic:discord.gg%2Fdecoders@cluster0.ekt40.mongodb.net/myFirstDatabase?retryWrites=true&w=majority",
  filters: {
